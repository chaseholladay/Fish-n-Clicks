<p align="center">
<a href="heroku deploy link goes here" target="_blank"><img src=pic of game goes here=true" alt="Project logo"/></a>
</p>

# Clicky-Game
Fish N Click Game - (REACT, Heroku)
...
* [Clicky-Game](add the deployed heruku link here)
...
<table>
  ...
  <tr>
    ...
    <td>git clone https://<i></i>github.com/chaseholladay/FishNClick.git</td>
  </tr>
  <tr>
...
* **** - *REACT* - [Clicky-Game Repo](https://github.com/Chase Holladay/Fish n Clicks)
